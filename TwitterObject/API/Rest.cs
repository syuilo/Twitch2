...
namespace Twitch
{
	public partial class Twitter
	{
		...
		public async Task<string> CreateList(
		...
		/// <returns></returns>
		public async Task<string> DeleteList(string slug, string ownerScreenName)
		{
			return await
				API.Rest.ListsDestroy(this, slug, ownerScreenName);
		}
